package SecurityApplication.SecurityApplication.config;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests(authConfig -> authConfig
                        ...
                        .requestMatchers(HttpMethod.GET, "/orders").hasRole("EMPLOYEE_SALES")
                        .requestMatchers(HttpMethod.GET, "/payments").hasRole("EMPLOYEE_FINANCE")
                )
